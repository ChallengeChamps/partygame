...
function loadCategories() {
  ...
  const premiumCats = ["sport", "wirtschaft", "tiere", "geografie", "unützes wissen", "musik", "filme und serien", "geschichte", "social media", "wissenschaft", "essen und trinken", "gaming"];
...
function createBoard() {
  ...
  if (currentCategory === "zufall") {
    const all = ["sport", "wirtschaft", "tiere", "geografie", "unützes wissen", "musik", "filme und serien", "geschichte", "social media", "wissenschaft", "essen und trinken", "gaming"];
